    ...
    def update_now_playing_label(self):
        if self.pipeline.get_state(0)[1] == Gst.State.PLAYING:
            ...
            if selected_song_iter:
                ...
                self.now_playing_label.set_text("Now Playing: (No track selected)")
        else:
            self.now_playing_label.set_text("Now Playing: (No track playing)")

        # Schedule the next update
        GObject.timeout_add(1000, self.update_now_playing_label)
