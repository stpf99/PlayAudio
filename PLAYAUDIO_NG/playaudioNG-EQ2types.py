...
class AudioPlayer(Gtk.Window):
    ...
    def update_equalizer_sliders(self):
        ...
        if self.equalizer_type == "10bands":
            self.equalizer_10bands.set_property("band0", 0)
            self.equalizer_10bands.set_property("band1", 0)
            self.equalizer_10bands.set_property("band2", 0)
            # itd., ustaw wartości dla wszystkich pasm equalizera

        elif self.equalizer_type == "3bands":
            self.equalizer_3bands.set_property("band0", 0)
            self.equalizer_3bands.set_property("band1", 0)
            self.equalizer_3bands.set_property("band2", 0)
            # ustaw wartości dla pasm equalizera
